  ...
  return create("div", { class: "cline" },
    ...
    create("div", { class: "ctrl" },
      create("div", { class: "stepper" },
        ...
        create("span", {}, l.qty),
        create("button", { onclick: () => cart.setQty(l.sku, l.qty + 1) }, "+")),
      create("input", { class: "disc", type: "text", inputmode: "decimal", value: l.lineDiscountPct || "",
        placeholder: "% הנחה", onchange: (e) => cart.setLineDiscount(l.sku, e.target.value) }),
  ...
  return create("div", { class: "totals" },
    ...
    create("div", { class: "r" },
      create("span", { class: "wd" }, "הנחה כללית ",
        create("input", { class: "disc", type: "text", inputmode: "decimal", value: state.wholeListDiscountPct || "",
          placeholder: "%", onchange: (e) => cart.setWholeDiscount(e.target.value) })),
